setwd("C:/Users/MS23/OneDrive - CEFAS/ICES working groups/WKGMSE 2020/Other_stuff/")
dat <- data.frame(
...
library(grDevices)
setEPS()
cairo_ps("round1to6.eps",width=5.5,height=5)
layout(mat=matrix(c(rep(c(1,3,5),times=wid),rep(c(2,4,6),times=wid),7,7,7),3,2 * wid + 1))
par(mar=c(2,2,1,1))
par(oma=c(3,3,2,2))
image_MS_no_legend(matrix(possible1 * (1-pcat1),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.49,0.9,1))
mtext("Round 1",3,outer=F,line=1)
points(round1[,2:1],pch=16,col="white")
axis(2)
image_MS_no_legend(matrix(possible2 * (1-pcat2),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.49,0.9,1))
mtext("Round 2",3,outer=F,line=1)
points(round2[-(1:8),2:1],pch=16,col="white")
image_MS_no_legend(matrix(possible3 * (1-pcat3),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.49,0.9,1))
mtext("Round 3",3,outer=F,line=1)
points(round3[-(1:16),2:1],pch=16,col="white")
axis(2)

image_MS_no_legend(matrix(possible4 * (1-pcat4),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.49,0.9,1))
mtext("Round 4",3,outer=F,line=1)
points(round4[-(1:24),2:1],pch=16,col="white")
image_MS_no_legend(matrix(possible5 * (1-pcat5),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.49,0.9,1))
mtext("Round 5",3,outer=F,line=1)
points(round5[-(1:32),2:1],pch=16,col="white")
axis(2)
axis(1)
image_MS_no_legend(matrix(possible6 * (1-pcat6),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.49,0.9,1))

axis(1)
mtext("Round 6",3,outer=F,line=1)
points(round6[-(1:40),2:1],pch=16,col="white")

image_MS_legend(matrix(possible6 * (1-pcat6),nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(-1e-12,0.0001,0.05,0.5,0.9,1),labs=c(0,0.0001,0.05,0.5,0.9,1))
mtext(expression(F[target]),1,outer=T,line=1)
mtext(expression(B[trigger]),2,outer=T,line=1)
dev.off()
...
library(grDevices)
setEPS()
cairo_ps("points.eps",width=5.5,height=5)
image2D(matrix(dat_round$Round,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab=expression(B[trigger]),ylab=expression(F[target]),breaks=(0:7),col = col_round[-1])
dev.off()

setEPS()
cairo_ps("uncertain_after7.eps",width=5.5,height=3)
par(mfrow=c(1,2))
par(oma=c(0,0,0,0))
par(mar=c(4,4.5,2,3))
image2D(matrix(pred_risk7_g$sd,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab=expression(B[trigger]),ylab=expression(F[target]),main="Risk")
image2D(matrix(pred_cat7_g$sd,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab=expression(B[trigger]),ylab=expression(F[target]),main="Catch")
dev.off()
...
par(oma=c(0,0,0,0))
par(mar=c(4,4.5,2,3))
image2D(matrix(med_risk1,nrow=11),breaks=c(0,0.01,0.025,0.05,0.1,0.2,0.6),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",main="a)")
points(round1[,2:1],pch=16,col="white")
image2D(matrix(med_cat1,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",main="b)")
points(round1[,2:1],pch=16,col="white")
#image2D(matrix(pred_risk1_g$sd,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",main="b)")
tmp <- matrix(prisk1,nrow=11)
tmp1 <- ifelse(tmp < 1e-12,1e-12,tmp)
image2D(matrix(tmp1,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(0,0.0001,0.05,0.5,0.9,1),main="c)")
points(round1[,2:1],pch=16,col="white")

tmp <- matrix(1-pcat1,nrow=11)
tmp1 <- ifelse(tmp < 1e-12,1e-12,tmp)
image2D(matrix(tmp1,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",breaks=c(0,0.0001,0.05,0.5,0.9,1),main="d)")
#image2D(matrix(pred_cat1_g$sd,nrow=11),y=sort(unique(dat$Ftrgt)),x=sort(unique(dat$Btrigger)),xlab="Btrigger",ylab="Ftrgt",,main="d)")
points(round1[,2:1],pch=16,col="white")
dev.off()
